	...
	if (r === true) {
		...
		if (document.getElementById('select').value == "phe") {
			...
			if (localStorage.getItem("plan") !== null) {
				var plan1 = localStorage.getItem("plan") + "<p class=\"plan\">" + name + ergebnis1.toFixed(2) + " Phe</p>";
			...
			var ergebnis2 = gewicht * (phe * 30) / 100;
			if (localStorage.getItem("plan") !== null) {
				var plan2 = localStorage.getItem("plan") + "<p class=\"plan\">" + name + ergebnis2.toFixed(2) + " Phe</p>";
			...
			var ergebnis3 = gewicht * (phe * 40) / 100;
			if (localStorage.getItem("plan") !== null) {
				var plan3 = localStorage.getItem("plan") + "<p class=\"plan\">" + name + ergebnis3.toFixed(2) + " Phe</p>";
			...
			var ergebnis4 = gewicht * (phe * 50) / 100;
			if (localStorage.getItem("plan") !== null) {
				var plan4 = localStorage.getItem("plan") + "<p class=\"plan\">" + name + ergebnis4.toFixed(2) + " Phe</p>";
...
function tagPlanfertig() {
	...
	if (r === true) {
		var today = new Date();
		var date = ("0" + today.getDate().toString()).substr(-2) + "." + ("0" + (today.getMonth() + 1).toString()).substr(-2) + "." + today.getFullYear().toString();
		...
		if (localStorage.getItem("liste") !== null) {
			...
			var liste1 = localStorage.getItem("liste") + "<p class=\"liste\"><span class=\"bold\">" + date + ":</span> " + gesamt7.toFixed(2) + " Phe</p>";
			...
			var startliste1 = "<p class=\"liste\"><span class=\"bold\">" + date + ":</span> " + gesamt7.toFixed(2) + " Phe</p>";
		...
		if (localStorage.getItem("tage") == 1) {
			document.getElementById("motivation").innerHTML = "<br><p>Super, dein erster Tag ist eingetragen.</p>";
			...
			document.getElementById("motivation").innerHTML = "<br><p>5 Tage, du hast fast schon eine Woche geschafft.</p>";
			...
			document.getElementById("motivation").innerHTML = "<br><p>Wenn dir die Tagesliste zu lang wird, kannst du sie auch zurücksetzen :P</p>";
		} else {
...
function plUs() {
	...
	if (r === true) {
		...
		if (localStorage.getItem("plan") !== null) {
			var plan5 = localStorage.getItem("plan") + "<p class=\"plan\"><span class=\"bold\">+</span> " + ergebnis5.toFixed(2) + " Phe</p>";
			...
			var startplan5 = "<p class=\"plan\"><span class=\"bold\">+</span> " + ergebnis5.toFixed(2) + " Phe</p>";
...
function miNus() {
	...
	if (r === true) {
		...
		if (localStorage.getItem("plan") !== null) {
			var plan6 = localStorage.getItem("plan") + "<p class=\"plan\"><span class=\"bold\">-</span> " + ergebnis6.toFixed(2) + " Phe</p>";
			...
			var startplan6 = "<p class=\"plan\"><span class=\"bold\">-</span> " + ergebnis7.toFixed(2) + " Phe</p>";
...
function spEichern() {
	...
	if (r === true) {
		...
		if (localStorage.getItem("plan") !== null) {
			var ubrig7 = parseFloat(localStorage.getItem("toleranz")) - parseFloat(localStorage.getItem("gesamt"));
...
if (localStorage.getItem("lebensmittel") !== null && localStorage.getItem("zwlebensmittel") == null) {
...
} else if (localStorage.getItem("lebensmittel") !== null && localStorage.getItem("zwlebensmittel") !== null) {
	var lminput = JSON.parse(localStorage.getItem("lebensmittel"));
	document.getElementById("lmwert").value = lminput[lminput.length - 1];
}

if (localStorage.getItem("zwlebensmittel") !== null && localStorage.getItem("lebensmittel") == null) {
...
} else if (localStorage.getItem("zwlebensmittel") !== null && localStorage.getItem("lebensmittel") !== null) {
	var lminput = JSON.parse(localStorage.getItem("zwlebensmittel"));
	document.getElementById("lmgewicht").value = lminput[lminput.length - 1];
}
